<header class="hmsheader container-fluid bg-white py-4 " style="position: sticky !important; top: 0; z-index: 1000;">
	<div class="d-flex flex-nowrap">
		<div class="my-auto">
			<i id="menuIcon" class="fa-solid fa-bars fs-5" role="button" ></i>
		</div>
		<div class="col-auto mx-auto">
			<h4 class="fw-bold "><?php echo $_SESSION['user_type']; ?> Account</h4>
		</div>
